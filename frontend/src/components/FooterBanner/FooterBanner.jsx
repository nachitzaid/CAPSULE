...
const FooterBanner = () => {
    ...
    return (
        < div ref={fbConRef} className="w-screen md:h-dvh h-[60vh] p-2 overflow-hidden" >
            <div className='w-full h-full relative overflow-hidden rounded-4xl'>
                ...
                <div className='absolute bottom-5 px-4 w-full'>
                    <div className="w-full h-auto flex md:flex-row flex-col md:justify-between md:items-end gap-10">
                        <h2
                            className="text-start lg:mt-0 md:text-[#f4efe7] text-[#b1a696] text-xl md:text-2xl font-bold md:tracking-wider leading-tight flex flex-col gap-1"
                        ...
                        <p
                            className="md:w-[20%] w-full text-[#f4efe7] text-[0.7rem] font-bold md:font-medium tracking-wide lg:text-end mt-2 text-justify"
                            style={{ textShadow: '2px 2px 4px #000' }}
                        >
